<meta name="google-site-verification" content="_vzhUtSgNKfuH5FIahU8IT16BmaECi9_1DfVgEG4BZ0" />
<style>
  ...
  .navbar-custom .btn-outline-dark:hover {
    color: #31AAE9;
    /* Màu chữ khi hover của nút */
    background-color: #fff;
    /* Màu nền khi hover của nút */
  }
</style>
<nav id="nav-bar"
  class="navbar navbar-expand-lg navbar-custom navbar-light bg-cyan px-lg-3 py-lg-2 shadow-sm sticky-top">
