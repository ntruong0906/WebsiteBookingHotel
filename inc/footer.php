<style>
  ...
  .footer-custom {
    ...
    /* Màu nền navbar */
    border-bottom: 3px solid #685AF5;
    /* Đường viền dưới của navbar */
    color: #fff;
  }
</style>

<div class="footer-custom container-fluid bg-cyan mt-5">
  <div class="row">
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="<?php echo $contact_r['iframe'] ?>" class="d-inline-block text-dark text-decoration-none mb-2">
        <i class="bi bi-geo-alt-fill"></i></i> Address
      </a><br>
    </div>
  </div>
</div>

<h6 class="text-center bg-dark text-white p-3 m-0">Booking hotel</h6>
